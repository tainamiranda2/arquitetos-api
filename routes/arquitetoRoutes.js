...
arquitetoRoutes.post("/arquiteto",async(req, res)=>{
     //  console.log(req.body)
        var {nome ,email , telefone , genero ,idade ,habilidades,conhecimento,experiencia , senha,papel}=req.body
     ...
     const arquiteto= await prisma.arquiteto.create({
        data:{
          nome ,email, telefone , genero, idade , senha,papel,habilidades,conhecimento,experiencia
        },
      })
      return res.status(200).json(arquiteto)
